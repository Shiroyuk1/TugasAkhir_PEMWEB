...
if (isset($_SESSION['NID'])) {
    $NID = $_SESSION['NID'];
    $user = query("SELECT * FROM user WHERE uid = $NID")[0];
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Dapatkan password yang ada di database berdasarkan NIM
    ...
    if ($oldPassword == $dbPassword) {
        ...
        mysqli_query($conn, "UPDATE user SET password = '$newPassword' WHERE uid = $NID");
