...
<body class="bg-body">
    ...
    <!-- Main -->
    <a href="functionMhs/index.php" class="text-decoration-none">
        <button type="button" class="btn btn-primary">Data Mahasiswa</button>
    </a>
    <a href="functionDosen/index.php" class="text-decoration-none">
        <button type="button" class="btn btn-primary">Data Dosen</button>
    </a>
    <a href="functionKry/index.php" class="text-decoration-none">
        <button type="button" class="btn btn-primary">Data Karyawan</button>
    </a>
