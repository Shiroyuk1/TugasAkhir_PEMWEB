                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="alamat" name="alamat"
                                value="<?= $kry["alamat"]; ?>" disabled readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="email" name="email"
                                value="<?= $kry["email"]; ?>" disabled readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="tlp" name="tlp"
                                value="<?= $kry["tlp"]; ?>" disabled readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="posisi" name="posisi"
                                value="<?= $kry["posisi"]; ?>" disabled readonly>
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-lg-6">
                <img src="../img/<?= $kry["gambar"] ?>" alt="foto_mhs" class="d-block mx-lg-auto img-fluid" width="50%"
